...
image: "/images/posts/adding-colour-swatches-to-shopify-collection-page/thumbnail.jpg"
...
![Shopify Products grid](/images/posts/adding-colour-swatches-to-shopify-collection-page/products-1.jpg "Example taken from an upcoming ecommerce site: www.pandaghost.com")
...
![Metafields](/images/posts/adding-colour-swatches-to-shopify-collection-page/metafields-1.jpg)
...
![Metafields](/images/posts/adding-colour-swatches-to-shopify-collection-page/metafields-2.jpg)

Now — if we go to a product in Shopify admin, we can find our metafield in the very bottom.

![Metafields](/images/posts/adding-colour-swatches-to-shopify-collection-page/metafields-3.jpg)

Let’s proceed by adding the colours that we wish to display for our product on the collection pages.

![Metafields](/images/posts/adding-colour-swatches-to-shopify-collection-page/metafields-4.jpg)

![Metafields](/images/posts/adding-colour-swatches-to-shopify-collection-page/metafields-5.jpg)
...
![Shopify Code Editor](/images/posts/adding-colour-swatches-to-shopify-collection-page/shopify-1.png)
...
![Shopify Code Editor](/images/posts/adding-colour-swatches-to-shopify-collection-page/shopify-2.png)
...
![Shopify Products grid](/images/posts/adding-colour-swatches-to-shopify-collection-page/products-2.jpg)
...
![Metafields](/images/posts/adding-colour-swatches-to-shopify-collection-page/metafields-6.jpg)
