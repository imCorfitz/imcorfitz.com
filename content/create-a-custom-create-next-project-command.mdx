...
![Hero](/images/posts/create-a-custom-create-next-project-command/hero.jpg)
...
![Why?](/images/posts/create-a-custom-create-next-project-command/why.gif)
...
![Terminal](/images/posts/create-a-custom-create-next-project-command/terminal.png)
...
![Screenshot](/images/posts/create-a-custom-create-next-project-command/screen.jpg)
